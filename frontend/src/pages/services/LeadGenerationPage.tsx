            ...
            <Card className="ai-card">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Build automated funnels that attract, nurture, and convert leads into customers. 
                  Our AI-powered systems score leads, personalize follow-ups, and optimize every 
                  touchpoint for maximum conversion rates.
                </p>
              </CardContent>
            </Card>
