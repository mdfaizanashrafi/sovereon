/**
 * ============================================================================
 * PODCAST PRODUCTION ONLY SERVICE PAGE
 * ============================================================================
 * 
 * @page
 */
            ...
            <Card className="ai-card">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Professional podcast production that makes your voice shine. From studio-quality 
                  recording to polished editing, we handle the technical details so you can focus 
          ...
          <div className="space-y-6">
            ...
            <Card className="ai-card bg-gradient-to-br from-primary/10 to-accent/10">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2">Start Your Podcast</h3>
