            ...
            <Card className="ai-card">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Combine the power of email and SMS marketing for maximum reach and engagement. 
                  Our AI-optimized platform determines the best channel, timing, and content for 
                  each message, ensuring your communications always hit the mark.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6">
            ...
            <Card className="ai-card bg-gradient-to-br from-primary/10 to-accent/10">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2">Unify Your Marketing</h3>
