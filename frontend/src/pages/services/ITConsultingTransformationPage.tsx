/**
 * ============================================================================
 * IT CONSULTING & DIGITAL TRANSFORMATION SERVICE PAGE
 * ============================================================================
 * 
 * @page
 */
...
export function ITConsultingTransformationPage() {
  const service = serviceCategories
    .find(c => c.id === 'cloud-it-solutions')
    ...
    <div className="pt-24 pb-16">
      <section className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          ...
          <Link to="/services/cloud-it-solutions" className="hover:text-primary transition-colors">Cloud</Link>
          <ArrowRight className="w-4 h-4" />
            ...
            <Card className="ai-card">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Navigate the digital landscape with confidence. Our expert consultants work 
                  with you to develop a comprehensive digital transformation strategy, recommend 
                  the right technology stack, and guide you through implementation to ensure 
                  your business stays competitive in the digital age.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6">
            ...
            <Card className="ai-card bg-gradient-to-br from-primary/10 to-accent/10">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2">Transform Your Business</h3>
