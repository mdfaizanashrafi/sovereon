/**
 * ============================================================================
 * BULK SMS SERVICE PAGE
 * ============================================================================
 * 
 * Individual service page for Bulk SMS with features, strategy, and CTA.
 * 
 * @page
 */
            ...
            <Card className="ai-card">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Our enterprise-grade Bulk SMS service is designed for high-volume messaging needs. 
                  With robust API integration, intelligent routing, and comprehensive delivery reporting, 
                  we ensure your messages reach their destination reliably and efficiently.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6">
            ...
            <Card className="ai-card bg-gradient-to-br from-primary/10 to-accent/10">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2">Scale Your Messaging</h3>
