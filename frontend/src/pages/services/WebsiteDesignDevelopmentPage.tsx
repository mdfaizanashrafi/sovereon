...
export function WebsiteDesignDevelopmentPage() {
  const service = serviceCategories
    ...
    ?.services.find(s => s.id === 'website-design-development')!;
  ...
  return (
    <>
      <SEO
        ...
        keywords="website design, web development, responsive design, SEO-friendly websites"
        schema={{
          ...
          '@graph': [
            ...
            buildBreadcrumbSchema([
              ...
              { name: service.title, url: '/services/website-design-development' }
            ])
          ]
        }}
      />
              ...
              <Card className="ai-card">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    We create stunning, responsive websites that not only look great but perform 
                    exceptionally. Our AI-powered design process analyzes user behavior patterns 
                    to create interfaces that convert visitors into customers. Every website is 
                    built with SEO best practices, fast loading speeds, and mobile-first design 
                    principles.
                  </p>
                </CardContent>
              </Card>
