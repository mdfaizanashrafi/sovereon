            ...
            <Card className="ai-card">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Professional photography that tells your brand story. From product shots to 
                  corporate headshots, we create stunning visuals that elevate your brand and 
                  engage your audience across all channels.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6">
            ...
            <Card className="ai-card bg-gradient-to-br from-primary/10 to-accent/10">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2">Book Your Shoot</h3>
