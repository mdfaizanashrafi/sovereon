            ...
            <Card className="ai-card">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Maximize your advertising ROI with AI-optimized campaigns across Google, 
                  Meta, and LinkedIn. Our data-driven approach ensures every rupee spent 
                  delivers measurable results, from brand awareness to conversions.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6">
            ...
            <Card className="ai-card bg-gradient-to-br from-primary/10 to-accent/10">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2">Maximize Your ROI</h3>
