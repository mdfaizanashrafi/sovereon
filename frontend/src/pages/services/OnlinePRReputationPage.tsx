/**
 * ============================================================================
 * ONLINE PR & REPUTATION MANAGEMENT SERVICE PAGE
 * ============================================================================
 * 
 * @page
 */
...
export function OnlinePRReputationPage() {
  const service = serviceCategories
    .find(c => c.id === 'content-media-production')
    ...
    <div className="pt-24 pb-16">
      <section className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          ...
          <Link to="/services/content-media-production" className="hover:text-primary transition-colors">Media</Link>
          <ArrowRight className="w-4 h-4" />
            ...
            <Card className="ai-card">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Your online reputation is your most valuable asset. We monitor, manage, and 
                  enhance your digital presence, responding to reviews, creating positive content, 
                  and protecting your brand from potential crises.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6">
            ...
            <Card className="ai-card bg-gradient-to-br from-primary/10 to-accent/10">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2">Protect Your Brand</h3>
