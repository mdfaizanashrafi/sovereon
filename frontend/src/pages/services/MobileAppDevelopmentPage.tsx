...
import { ArrowRight, CheckCircle, TrendingUp, Smartphone } from 'lucide-react';
...
export function MobileAppDevelopmentPage() {
  const service = serviceCategories
    ...
    ?.services.find(s => s.id === 'mobile-app-development')!;
        ...
        schema={{
          ...
          '@graph': [
            ...
            buildBreadcrumbSchema([
              ...
              { name: service.title, url: '/services/mobile-app-development' }
            ])
          ]
        }}
      />
              ...
              <Card className="ai-card">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    From concept to App Store, we build mobile applications that users love. 
                    Our apps combine beautiful design with powerful functionality, incorporating 
                    AI features, push notifications, and offline capabilities to deliver 
