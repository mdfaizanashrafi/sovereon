  ...
  return (
    <>
      <SEO
        ...
        canonical="/services/ai-content-generation"
        keywords="AI content, content automation, AI writing, blog automation"
        schema={{
          '@context': 'https://schema.org',
          '@graph': [
            buildServiceSchema(service.title, service.fullDescription, '/services/ai-content-generation'),
            buildBreadcrumbSchema([
              { name: '', url: '/' },
              { name: '', url: '/services' },
              { name: '', url: '/services/ai-services' },
              { name: service.title, url: '/services/ai-content-generation' },
            ]),
          ],
        }}
      />
