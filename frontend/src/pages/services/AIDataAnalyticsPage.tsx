...
import { BarChart3, CheckCircle, ArrowRight, TrendingUp, Brain, LineChart } from 'lucide-react';
...
export function AIDataAnalyticsPage() {
  const service = serviceCategories
    ...
    ?.services.find(s => s.id === 'ai-data-analytics');
  ...
  return (
    <>
      <SEO
        ...
        keywords="AI analytics, predictive analytics, machine learning, data insights"
        schema={{
          '@context': 'https://schema.org',
          '@graph': [
            buildServiceSchema(service.title, service.fullDescription, '/services/ai-data-analytics'),
            buildBreadcrumbSchema([
              { name: '', url: '/' },
              { name: '', url: '/services' },
              { name: '', url: '/services/ai-services' },
              { name: service.title, url: '/services/ai-data-analytics' },
            ]),
          ],
        }}
      />
