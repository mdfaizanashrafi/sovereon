            ...
            <Card className="ai-card">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Our AI-driven SEO strategies help you climb search rankings and stay there. 
                  From technical audits to content optimization, we use advanced algorithms 
                  to identify opportunities and implement strategies that drive sustainable 
          ...
          <div className="space-y-6">
            ...
            <Card className="ai-card bg-gradient-to-br from-primary/10 to-accent/10">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2">Rank Higher Today</h3>
