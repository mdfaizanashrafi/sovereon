            ...
            <Card className="ai-card">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Create stunning video advertisements that capture attention and drive action. 
                  From concept to final cut, our professional production team delivers 
                  cinematic-quality ads for TV, online platforms, and social media.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6">
            ...
            <Card className="ai-card bg-gradient-to-br from-primary/10 to-accent/10">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2">Create Your Ad</h3>
